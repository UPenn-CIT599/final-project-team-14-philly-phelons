 ...
 * 
 *         Class to create an NBA game object. For use with file "NBA Games.csv"
 *         Seasons included range from 1947 t0 2015. All column data that
 *         (initially) seems useful to group project concerns is included, but
 *         there is much more data contained in the file. Also, data listed
 *         below may not be in the order in which it is arranged in the csv
 *         file.
 *
 */
public class nba {
