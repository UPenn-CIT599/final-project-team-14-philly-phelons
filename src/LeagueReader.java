...
public class LeagueReader {
    ...
    public static ArrayList<Games> MLBArray;
    public static ArrayList<Games> NBAArray;
    public static ArrayList<Games> NHLArray;
    public static ArrayList<Games> NFLArray;
