...
//        
    ...
    public Object getMethodName(String methodName) throws ParseException { //The following trivial methods are used by the CrimeReader class 
        ...
        if(methodName.equals("getDispatchDate.getYear()")) {
            return getDispatchDate().getYear();
        }
        if(methodName.equals("getDispatchDate().getMonth()")) {
            return getDispatchDate().getMonthValue();
        }
        if(methodName.equals("getDispatchDate().getDay()")) {
            return getDispatchDate().getDayOfMonth();
        }
        return null;
    }
}
